...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        # instantiate the sprite class as well:
        super().__init__()
...
# Groups
# to draw sprites: create sprite, place sprites in Group or GroupSingle, then draw/update all sprites in that group
# we need different groups for our player and our obstacles so we can look for collions
